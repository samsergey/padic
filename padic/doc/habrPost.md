...
True
````
Трансцедентные уравнения тоже можно решать методом Гензеля. Например, вот 7-адическое число, синус которого равен 7^2:
