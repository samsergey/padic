...
type instance Padic Fixed p prec = Z p prec
type instance Padic Word32 p _ = Z p (SufficientPrecision Word32 p)
type instance Padic Int p _ = Z p (SufficientPrecision Int p)
